  ...
  const renderCategoryList = (categoryList: Category[]) => (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
      {categoryList.map((category, index) => (
        <div
          key={category.id}
          className="group flex items-center justify-between p-4 bg-card border border-border/50 rounded-lg hover:border-primary/30 hover:shadow-md hover:shadow-primary/5 transition-all duration-200 animate-fade-up"
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        <Tabs defaultValue="expense" className="w-full animate-fade-up" style={{ animationDelay: '100ms' }}>
          <TabsList className="grid w-full max-w-md grid-cols-2 p-1">
            <TabsTrigger 
              value="expense" 
              className="gap-2 data-[state=active]:bg-destructive/10 data-[state=active]:text-destructive transition-all duration-200"
            >
            ...
            <TabsTrigger 
              value="income" 
              className="gap-2 data-[state=active]:bg-emerald-500/10 data-[state=active]:text-emerald-500 transition-all duration-200"
            >
